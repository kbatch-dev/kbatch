...
After you've [configured](./index.html#configure-with-jupyterhub-deployment) `kbatch`, you can submit jobs, list previously submitted jobs, and query the details of individual jobs.
